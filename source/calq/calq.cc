...
int main(int argc, char *argv[]) {
    try {
        ...
        TCLAP::SwitchArg forceSwitch(
            "f",
            "force",
            "Force overwriting of output files etc.",
            cmd,
            false
        );
        TCLAP::UnlabeledValueArg<std::string> inputFileNameArg(
            "inputFileName",
            "Input file name",
            true,
            "",
        ...
        TCLAP::ValueArg<int> blockSizeArg(
            "b",
            "blockSize",
            "Block size (in number of SAM records)",
            false,
            10000,
            "int",
            cmd
        );
        TCLAP::ValueArg<int> polyploidyArg(
            "p",
            "polyploidy",
            "Polyploidy",
            false,
        ...
        TCLAP::ValueArg<std::string> qualityValueTypeArg(
            "q",
            "qualityValueType",
            "Quality value type (Sanger: Phred+33 [0,40]; Illumina-1.3+: Phred+64 [0,40]; Illumina-1.5+: Phred+64 [0,40]; Illumina-1.8+: Phred+33 [0,41]; Max33: Phred+33 [0,93]; Max64: Phred+64 [0,62])",
            false,
            "Illumina-1.8+",
            "string",
            cmd
        );
        TCLAP::MultiArg<std::string> referenceFileNamesArg(
            "r",
            "referenceFileNames",
            "Reference file name(s) (FASTA format)",
            false,
            "string",
            cmd
        );
        ...
        TCLAP::SwitchArg decompressSwitch(
            "d",
            "decompress",
            "Decompress",
            cmd,
        ...
        TCLAP::ValueArg<std::string> sideInformationFileNameArg(
            "s",
