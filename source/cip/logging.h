...
#define CALQ_DEBUG(c, ...)                                                  \
    do {                                                                    \
        ...
        fprintf(stderr, "DEBUG  %s %s:%s:%d: " c "\n",                      \
                calq::currentDateAndTime().c_str(), __FILE__, __FUNCTION__, \
...
#define CALQ_LOG(c, ...)                                      \
    do {                                                      \
        fflush(stdout);                                       \
        fprintf(stdout, "LOG  %s %s: " c "\n",                \
                cip::currentDateAndTime().c_str(),            \
                cip::removeFileNameExtension(                 \
                    cip::fileBaseName(std::string(__FILE__))) \
                    .c_str(),                                 \
                ##__VA_ARGS__);                               \
    } while (false)
...
#define CALQ_ERROR(c, ...)                                             \
    do {                                                               \
        ...
        fprintf(stderr, "ERROR  %s " c "\n",                           \
                calqapp::currentDateAndTime().c_str(), ##__VA_ARGS__); \
    } while (false)
