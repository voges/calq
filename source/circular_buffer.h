 ...
 *  @brief This file contains the definition of a ring buffer.
 */

// Copyright 2015-2018 Leibniz Universitaet Hannover

#ifndef CALQ_QUALCODEC_CIRCULARBUFFER_H_
#define CALQ_QUALCODEC_CIRCULARBUFFER_H_
...
#endif  // CALQ_QUALCODEC_CIRCULARBUFFER_H_
