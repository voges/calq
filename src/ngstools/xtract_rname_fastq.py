...
###############################################################################
#           Extract the sequence identifiers from a FASTQ file                #
###############################################################################
...
if len(sys.argv) != 2:
    sys.exit("Usage: python {} file.[fastq|fq] 2> file.rname".format(sys.argv[0]))
...
while 1:
    ...
    sys.stderr.write(sequence_identifier + "\n")
