...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        TCLAP::ValueArg<std::string> qualityValueTypeArg("q", "qualityValueType", "Quality value type (Sanger, Illumina-1.3+, Illumina-1.5+, Illumina-1.8+)", false, "Illumina-1.8+", "string", cmd);
