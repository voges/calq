...
printf "[2/4] SNP / Indel extraction\n"
...
$java $java_opts -jar $GenomeAnalysisTK_jar -T ApplyRecalibration -R $ref_fasta -L $chromosome -input $input_bam.GATK.indels.vcf -mode INDEL -recalFile $input_bam.indels.recal -tranchesFile $input_bam.indels.tranches --ts_filter_level $filterLevel900 -o $input_bam.GATK.indels.filtered900.vcf &>>$log_txt
$java $java_opts -jar $GenomeAnalysisTK_jar -T ApplyRecalibration -R $ref_fasta -L $chromosome -input $input_bam.GATK.indels.vcf -mode INDEL -recalFile $input_bam.indels.recal -tranchesFile $input_bam.indels.tranches --ts_filter_level $filterLevel990 -o $input_bam.GATK.indels.filtered990.vcf &>>$log_txt
$java $java_opts -jar $GenomeAnalysisTK_jar -T ApplyRecalibration -R $ref_fasta -L $chromosome -input $input_bam.GATK.indels.vcf -mode INDEL -recalFile $input_bam.indels.recal -tranchesFile $input_bam.indels.tranches --ts_filter_level $filterLevel999 -o $input_bam.GATK.indels.filtered999.vcf &>>$log_txt
$java $java_opts -jar $GenomeAnalysisTK_jar -T ApplyRecalibration -R $ref_fasta -L $chromosome -input $input_bam.GATK.indels.vcf -mode INDEL -recalFile $input_bam.indels.recal -tranchesFile $input_bam.indels.tranches --ts_filter_level $filterLevel1000 -o $input_bam.GATK.indels.filtered1000.vcf &>>$log_txt
