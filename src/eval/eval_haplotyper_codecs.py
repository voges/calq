...
codecs = [[".sam", ".calq-0b74e3d", ""], [".bam", ".crumble-0.5", "-1"],[".bam", ".crumble-0.5", "-9"], ["", ".dsrc_2.0-il8b", ""], [".fastq", ".quartz-0.2.2", ".fastq.clipped_qual.aln_bowtie2.sorted.dupmark.rg"], [".sam", ".qvz2-d5383c6", "-t1"], [".sam", ".qvz2-d5383c6", "-t2"], [".sam", ".qvz2-d5383c6", "-t3"], [".sam", ".qvz2-d5383c6", "-t4"], [".sam", ".qvz2-d5383c6", "-t8"]]
