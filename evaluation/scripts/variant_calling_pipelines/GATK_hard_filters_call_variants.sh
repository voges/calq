...
$java $java_opts -jar $GenomeAnalysisTK_jar -T VariantFiltration -R $ref_fasta -L $chromosome -V $input_bam.snps.vcf --filterExpression "$filterExpression" --filterName "$filterName" -o $input_bam.snps.hard_filtered.vcf
printf "OK\n";
