function plot_joint_PRF(size, P, metric, subposition)
...
for i = 1: length(size)
    plot(size(i),mean(P(i,:),2),markers{i},'Color', colors(i,:),'MarkerFaceColor',colors(i,:), 'MarkerSize', 14,'LineWidth',2 );
    hold on;
end
...
title([metric],'fontsize',20,'Interpreter','Latex');
